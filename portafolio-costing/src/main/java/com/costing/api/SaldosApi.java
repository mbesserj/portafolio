...
public final class SaldosApi {
     ...
     */
    public static SaldoApiInterfaz createService() {
        
        // --- PASO 1: Obtener la dependencia fundamental: EntityManager ---
        // Usamos la interfaz como tipo de variable para buenas prácticas.
        SaldoApiInterfaz saldoService = new SaldosServiceImpl();
          
        // --- PASO 2: Devolver el servicio completamente ensamblado ---
        // El cliente que llama a este método no sabe nada sobre SaldoServiceImpl,
        // repositorios, o procesos. Solo conoce la interfaz SaldoApiInterfaz.
        return saldoService;
    }
}