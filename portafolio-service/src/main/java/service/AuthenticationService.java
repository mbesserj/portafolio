...
import com.app.config.PasswordSecurityConfig;
import com.app.config.PasswordSecurityConfig.PasswordValidationResult;
    ...
    public AuthenticationResult autenticar(String usuario, String password) {
        ...
        return executeReadOnly(em -> {
            try {
                ...
                String sql_usuario_by_username = QueryRepository.getUsuarioQuery(QueryRepository.UsuarioQueries.HAY_USUARIO_QUERY);

                TypedQuery<UsuarioEntity> query = em.createQuery(sql_usuario_by_username, UsuarioEntity.class);
