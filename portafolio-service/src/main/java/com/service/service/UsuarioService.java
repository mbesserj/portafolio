...
import com.service.service.AuthenticationService.PasswordEncodingResult;
    ...
    public UserRegistrationResult registrarNuevoUsuario(String username, String password, String email) {
        ...
        return executeInTransaction(em -> {
            try {
                ...
                nuevoUsuario.setUsuario(username.trim().toLowerCase()); // Normalizar username
                nuevoUsuario.setCorreo(email.trim().toLowerCase()); // Normalizar email
                nuevoUsuario.setPassword(encodingResult.getEncodedPassword()); // Contraseña ya codificada
