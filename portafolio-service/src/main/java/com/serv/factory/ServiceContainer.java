...
public final class ServiceContainer {
    ...
    public final Map<Class<?>, Supplier<?>> serviceRegistry = new ConcurrentHashMap<>();
    ...
    private void registerCoreServices() {
        ...
        serviceRegistry.put(AggregatesForInstrument.class, () -> new AggregatesForInstrument());

        // === SERVICIOS BÁSICOS ===
        serviceRegistry.put(AuthenticationService.class, () -> new AuthenticationService(
                getService(BCryptPasswordEncoder.class)));
        serviceRegistry.put(PerfilService.class, () -> new PerfilService());
        ...
        // === SERVICIOS DEPENDIENTES DE APIs EXTERNAS ===
    ...
    private TipoMovimientosService createTipoMovimientosService() {
        try {
            ...
            return new TipoMovimientosService((com.model.interfaces.TipoMovimiento) tipoMovimientoImpl);
        } catch (ClassNotFoundException e) {
