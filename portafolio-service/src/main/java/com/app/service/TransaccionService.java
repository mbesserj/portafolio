...
public class TransaccionService extends AbstractRepository {
    ...
    private static final String QUERY_TRANSACCION_COMPLETA = """
    ...
    public TransaccionEntity obtenerTransaccionPorId(Long id) {
        ...
        return executeReadOnly(em -> {
            try {
                TypedQuery<TransaccionEntity> query = em.createQuery(QUERY_TRANSACCION_COMPLETA, TransaccionEntity.class);
