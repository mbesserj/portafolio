...
public class SaldoMensualService {
    ...
    public List<SaldoMensualDto> obtenerSaldosMensuales(String razonSocial, String custodio, int anio, String moneda) {
        ...
        try {
            ...
            // --- PASO 1: EJECUCIÓN DE CONSULTA (Sin cambios) ---
            ...
            """, montoColumn, montoColumn, montoColumn, montoColumn, montoColumn, montoColumn, montoColumn, montoColumn, montoColumn, montoColumn, montoColumn, montoColumn));
            ...
            Query query = entityManager.createNativeQuery(sqlBuilder.toString(), "SaldoMensualMapping");
    ...
    // ✅ RENOMBRADO: Ahora se llama "Variación Anual" para mayor claridad
    ...
    // Calcula la variación de cada mes contra el mes anterior
    private SaldoMensualDto calcularFilaVariacionMensual(SaldoMensualDto totalRow, int ultimoMesConDatos) {
        ...
        setValorPorMes(variationRow, 1, BigDecimal.ZERO); // Enero no tiene mes anterior para comparar
    ...
    // --- MÉTODOS DE AYUDA (HELPERS) (Sin cambios) ---
