...
public final class ServiceContainer {
    ...
    private ServiceContainer() {
        // CAMBIO 2: El contenedor registra todas las recetas en su constructor.
        registerServices();
    }
    ...
    private void registerServices() {
        ...
        // Los repositorios también son servicios Singleton gestionados por el contenedor.
        serviceRegistry.put(ConfrontaRepInterfaz.class, ConfrontaRepositoryImpl::new);
        serviceRegistry.put(ResultadoInsInterfaz.class, ResultadoInstrumentoRepositoryImpl::new);
        

        // --- Registro de Servicios (Lógica de Negocio) ---
        // El contenedor sabe cómo obtener las dependencias que necesita usando getService().
        serviceRegistry.put(ConfrontaService.class, () -> new ConfrontaService(getService(ConfrontaRepInterfaz.class)));
        ...
        serviceRegistry.put(ResultadoInstrumentoService.class, () -> new ResultadoInstrumentoService(
                ...
                getService(ResultadoInsInterfaz.class)));
        ...
        serviceRegistry.put(SaldoActualService.class, () -> new SaldoActualService(
                getService(KardexApiInterfaz.class), 
                getService(PrecioRepInterfaz.class)));
        ...
        serviceRegistry.put(AuthenticationService.class, AuthenticationService::new);
