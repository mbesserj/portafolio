...
public class ConfrontaRepositoryImpl implements ConfrontaRepository {
    ...
    public List<ConfrontaSaldoDto> obtenerDiferenciasDeSaldos(LocalDate fechaCorte) {
        ...
        try {
            ...
            Query query = em.createNativeQuery(nativeSql, "ConfrontaSaldoMapping");
            query.setParameter("fechaCorte", fechaCorte);
            return query.getResultList();

        } catch (Exception e) {
            logger.error("Error al ejecutar la consulta de confronta de saldos en el repositorio.", e);
