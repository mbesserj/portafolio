...
public class ConfrontaSaldosController {
    ...
    @FXML private TableView<ConfrontaSaldoDto> tablaDiferencias;

    // --- Columnas de la tabla ---
    @FXML private TableColumn<ConfrontaSaldoDto, String> colEmpresa;
    @FXML private TableColumn<ConfrontaSaldoDto, String> colCustodio;
    @FXML private TableColumn<ConfrontaSaldoDto, String> colInstrumento;
    @FXML private TableColumn<ConfrontaSaldoDto, String> colCuenta;
    @FXML private TableColumn<ConfrontaSaldoDto, LocalDate> colFechaKardex;
    @FXML private TableColumn<ConfrontaSaldoDto, BigDecimal> colCantidadKardex;
    @FXML private TableColumn<ConfrontaSaldoDto, BigDecimal> colValorKardex;
    @FXML private TableColumn<ConfrontaSaldoDto, LocalDate> colFechaSaldos;
    @FXML private TableColumn<ConfrontaSaldoDto, BigDecimal> colCantidadSaldos;
    @FXML private TableColumn<ConfrontaSaldoDto, BigDecimal> colValorSaldos;
    @FXML private TableColumn<ConfrontaSaldoDto, BigDecimal> colDifCantidad;

    public ConfrontaSaldosController() {
