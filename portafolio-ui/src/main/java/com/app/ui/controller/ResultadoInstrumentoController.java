...
public class ResultadoInstrumentoController implements Initializable {
    ...
    public ResultadoInstrumentoController(ResultadoInstrumentoService resultadoInstrumentoService, ServiceFactory serviceFactory, ResourceBundle resourceBundle) {
        this.resultadoInstrumentoService = resultadoInstrumentoService;
    ...
    private void handleBuscar() {
        ...
        Task<List<ResultadoInstrumentoDto>> task = new Task<>() {
            ...
            protected List<ResultadoInstrumentoDto> call() throws Exception {
                // --- OBTENCIÓN DE DATOS DEL FILTRO (CORREGIDA) ---
                // Se usan los getters públicos del componente FiltroGrupo.
