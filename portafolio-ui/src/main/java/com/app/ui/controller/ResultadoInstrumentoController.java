...
public class ResultadoInstrumentoController extends BaseController implements Initializable {
    ...
    private void handleBuscar() {
        ...
        Task<List<ResultadoInstrumentoDto>> task = new Task<>() {
            @Override
            protected ServiceResult<List<ResultadoInstrumentoDto>> call() throws Exception {
                ...
                return facade.obtenerHistorialResultados(empresaId, custodioId, cuenta, instrumentoId);
            }
        };
