 ...
 */
public class ResumenPortafolioController implements Initializable {
    ...
    public ResumenPortafolioController(ServiceFactory serviceFactory, ResourceBundle resourceBundle) {
    ...
    private void loadInitialData() {
        ...
        TaskManager.executeAsync(
                () -> serviceFactory.obtenerEmpresasConTransacciones(),
    ...
    private void loadCustodios() {
        ...
        TaskManager.executeAsync(
                () -> serviceFactory.obtenerCustodiosPorEmpresa(empresaSeleccionada.getId()),
    ...
    private void loadCuentas() {
        ...
        TaskManager.executeAsync(
                () -> serviceFactory.getCustodioService().obtenerCuentasPorCustodioYEmpresa(custodio.getId(), empresa.getId()),
    ...
    private void cargarResumen() {
        ...
        TaskManager.executeAsync(
                () -> serviceFactory.obtenerResumenPortafolio(empresa.getId(), custodio.getId(), cuenta),
