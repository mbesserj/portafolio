...
/**
 * Controlador para la vista de resumen de portafolio.
 * Maneja la interfaz de usuario para mostrar el resumen de inversiones por cuenta.
 */
public class ResumenPortafolioController implements Initializable {
    ...
    // ===== DATOS Y SERVICIOS =====
    private PortafolioFacade facade = ServiceFactory.getPortafolioFacade();
