...
public class SaldosController implements MainPaneAware, Initializable {

    // --- Referencia al panel principal ---
    private BorderPane mainPane;
    private ResourceBundle resourceBundle;

    // --- Servicios del Core (se inicializarán en initialize) ---
    private final SaldoActualService saldoService;
    ...
    public SaldosController(SaldoActualService saldoService,ServiceFactory serviceFactory, ResourceBundle resourceBundle) {
    ...
    private void handleBuscarSaldos() {
        ...
        Task<List<ResumenSaldoDto>> loadTask = new Task<>() {
            ...
            protected List<ResumenSaldoDto> call() throws Exception {
                return saldoService.obtenerSaldosValorizados(empresa.getId(), custodio.getId());
            }
        };
