...
import com.app.ui.factory.ServiceResult;
...
public class NavigatorService {
    ...
    public NavigatorService(ControllerFactory controllerFactory, ResourceBundle bundle, Stage primaryStage) {
    ...
    public boolean mostrarVentanaLogin() {
        try {
            ...
            dialogStage.setTitle(bundle.getString("login.titulo"));
            ...
            logger.error("Error al cargar la ventana de login", e);
            Alertas.mostrarAlertaError("Error Crítico", "No se pudo iniciar la ventana de login.");
            return false;
        }
    }
    ...
    public void mostrarVentanaPrincipal() {
        try {
            FXMLLoader loader = createLoader("/fxml/MainView.fxml");
            Parent root = loader.load();
    ...
    public void mostrarVentanaTiposMovimiento() {
        showModalWindowWithServiceCheck("/fxml/TipoMovimientosView.fxml", "ventana.tiposMovimiento.titulo", TipoMovimientosService.class);
    }
