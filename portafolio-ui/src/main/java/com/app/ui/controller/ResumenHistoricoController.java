...
public class ResumenHistoricoController {
    ...
    private final ResumenHistoricoService resumenService;
    ...
    public ResumenHistoricoController(ResumenHistoricoService resumenService, ServiceFactory serviceFactory, ResourceBundle resourceBundle) {
    ...
    public void initialize() {
        ...
        filtroGrupo.nemoValueProperty().addListener((obs, oldVal, newVal) -> {
            if (filtroGrupo.getCmbEmpresa().getValue() != null) {
